...
namespace SPiApp2.Components.Settings
{
    ...
    public class UserData : SettingsFile
    {
        ...
        private const string SELECTED_MOD_TYPE = "SelectedModType";
        ...
        private const string MAP_VALIDATE = "MapZoneValidate";
        private const string MOD_VALIDATE = "ModZoneValidate";
            ...
            base(false)
        {
            ...
            Bind(SELECTED_MOD_TYPE, "Singleplayer");
            ...
            Bind(MAP_VALIDATE, true);
            Bind(MOD_VALIDATE, true);
        }
        ...
        /// <summary>
        /// Get or set the last selected mod type.
        /// </summary>
        public static string SelectedModType
        {
            get
            {
                return Instance.GetString(SELECTED_MOD_TYPE);
            }
            set
            {
                Instance.SetString(SELECTED_MOD_TYPE, value);
            }
        }
        ...
        /// <summary>
        /// Get or set whether to validate the map's zone file when saving.
        /// </summary>
        public static bool MapZoneValidate
        {
            get
            {
                return Instance.GetBool(MAP_VALIDATE);
            }
            set
            {
                Instance.SetBool(MAP_VALIDATE, value);
            }
        }

        /// <summary>
        /// Get or set whether to validate the mod's zone file when saving.
        /// </summary>
        public static bool ModZoneValidate
        {
            get
            {
                return Instance.GetBool(MOD_VALIDATE);
            }
            set
            {
                Instance.SetBool(MOD_VALIDATE, value);
            }
        }
    }
}
