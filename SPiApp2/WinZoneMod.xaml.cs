...
namespace SPiApp2
{
    ...
    public partial class WinZoneMod : SPiApp2.Controls.CompilerWindow
    {
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            modZoneValidate.IsChecked = UserData.ModZoneValidate;
        ...
        private void Click_Save(object sender, RoutedEventArgs e)
        {
            ...
            UserData.ModZoneValidate = modZoneValidate.IsChecked.Value;
            ...
            if (Components.ZoneVerifier.Validate(textZone.Text))
            {
