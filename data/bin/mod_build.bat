...
::============================
:: NOTES
::   Rawfiles are copied by the tools internally;
::   this allows for dynamic directory names like
::   codjumper without copying all the other
::   directories that do not contain content that
::   needs to be compiled into the mod.
::============================
